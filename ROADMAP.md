...
| **M4 — Companion libs + polish** | NCCL + cuBLAS-extra slots, `exec` / `shell`, shell completions, richer `ls-remote`, integration/smoke harness | WU-19 – WU-21 | 🟢 **In progress** — WU-21 (`exec`/`shell` + completions + richer `ls-remote`) landed; WU-19 (harness) + WU-20 (NCCL) pending | [Milestone #4](https://github.com/danghoangnhan/cuvm/milestone/4) |
